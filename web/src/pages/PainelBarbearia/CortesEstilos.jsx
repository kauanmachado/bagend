        ...
        <Row className="justify-content-center shadow">
          ...
          <ListGroup horizontal variant="flush" className="mt-3 d-flex">
            ...
            <ListGroup.Item className="p-3 rounded mx-2 mb-3 text-start">
                ...
                <Button className="bg-danger px-4 py-2 btnRed shadow rounded-pill mt-xl-5 me-xl-2 "><MdFreeCancellation/>Remover</Button>
                <Button className="bg-dark px-4 py-2  btnDark shadow rounded-pill mt-xl-5 "><AiOutlineEdit/>Editar</Button>
              </ListGroup.Item>
              <ListGroup.Item className="p-3 rounded  mx-2 mb-3 text-start">
                <hr></hr>
                <h5 className="fw-bold fs-6 text-uppercase">Corte degradê</h5>
